...
REM
REM Generated by Vivado on Fri Sep 27 16:56:56 +0530 2024
...
echo "xvlog --incr --relax -prj MMMS_bus_tb_vlog.prj"
call xvlog  --incr --relax -prj MMMS_bus_tb_vlog.prj -log xvlog.log
