...
REM
REM Generated by Vivado on Thu Sep 26 08:25:39 +0530 2024
...
echo "xvlog --incr --relax -prj tb_slave_vlog.prj"
call xvlog  --incr --relax -prj tb_slave_vlog.prj -log xvlog.log
