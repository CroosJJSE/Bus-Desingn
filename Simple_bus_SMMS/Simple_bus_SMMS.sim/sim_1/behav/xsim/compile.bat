...
REM
REM Generated by Vivado on Fri Sep 27 14:38:48 +0530 2024
...
echo "xvlog --incr --relax -prj SMMS_bus_tb_vlog.prj"
call xvlog  --incr --relax -prj SMMS_bus_tb_vlog.prj -log xvlog.log
