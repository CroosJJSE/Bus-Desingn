...
REM
REM Generated by Vivado on Thu Sep 26 11:06:49 +0530 2024
...
echo "xvlog --incr --relax -prj master_slave_tb_vlog.prj"
call xvlog  --incr --relax -prj master_slave_tb_vlog.prj -log xvlog.log
