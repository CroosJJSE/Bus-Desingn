...
REM
REM Generated by Vivado on Thu Sep 26 08:53:24 +0530 2024
...
echo "xvlog --incr --relax -prj tb_master_interface_vlog.prj"
call xvlog  --incr --relax -prj tb_master_interface_vlog.prj -log xvlog.log
