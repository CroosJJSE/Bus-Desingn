...
HD_PWD='/home/subi/Desktop/ADS/bus/basic/Bus-Desingn/basic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_top_level.tcl
